...
namespace CrystallGrow
{
    public class Config
    {
        ...
        {
            return d > 10 ? Math.Pow(d, 1.3)*0.1 : 2;
        };

        public static Func<int, int> PurposeEnergy = i =>
        {
            return (int) Math.Ceiling(Math.Pow(i, 0.5)*8.1);
        };
        ...
        public static Func<int, int> SeedRate = i => 60;
        ...
        public const int MinAnnealInterval = 15;

        /// <summary>
        /// (Current Interval - MinAnnealInterval) -> Invoke P
        /// </summary>
        public static Func<int, double> AnnealInvokeP = i => Math.Min(0.2, Math.Pow(i, 1.1)/100.0);
